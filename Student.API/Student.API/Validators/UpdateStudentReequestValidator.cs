...
{
    public class UpdateStudentReequestValidator:AbstractValidator<updateStudentRequest>
    {
        public UpdateStudentReequestValidator(IStudentRepository studentRepository)
        {
